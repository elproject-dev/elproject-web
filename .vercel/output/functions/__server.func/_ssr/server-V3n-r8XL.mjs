import "../_runtime.mjs";
import { n as toResponse, t as H3Event } from "../_libs/h3+rou3+srvx.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v--eAugiXN.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BaFNPTZO.mjs"),
		import("./start-BAEJveYh.mjs"),
		import("./empty-plugin-adapters-DQPqZsaI.mjs")
	]);
	return {
		routerEntry,
		startEntry,
