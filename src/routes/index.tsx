...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Layanan jasa pembuatan aplikasi mobile (Android, iOS), web apps, software custom, dan website profesional di Yogyakarta. Developer terpercaya untuk bisnis Anda." },
      { name: "keywords", content: "jasa pembuatan aplikasi, jasa pembuatan aplikasi Yogyakarta, jasa buat aplikasi jogja, software house jogja, developer aplikasi, pembuatan website, aplikasi kasir" },
    ...
    <main className="min-h-screen overflow-x-hidden">
      ...
      <section className="sr-only">
        <div className="w-full max-w-[96vw] 2xl:max-w-[1600px] mx-auto text-sm text-muted-foreground/80 space-y-6">
          <div>
            <h2 className="text-lg font-bold text-foreground/90 mb-2 drop-shadow-sm">Jasa Pembuatan Aplikasi Yogyakarta & Website Profesional</h2>
            <p className="leading-relaxed">
              Di era digital saat ini, memiliki platform digital yang andal adalah keharusan. EL Project hadir sebagai <strong>Software House Yogyakarta</strong> yang menyediakan <strong>jasa pembuatan aplikasi</strong> terbaik untuk kebutuhan bisnis Anda. Mulai dari <strong>aplikasi kasir (POS)</strong>, <strong>sistem ERP</strong>, hingga <strong>aplikasi booking dan antrean</strong>. Tim kami terdiri dari developer berpengalaman di Jogja yang siap memberikan solusi pengembangan <strong>aplikasi mobile Android dan iOS</strong> yang responsif, cepat, dan <em>user-friendly</em>.
            </p>
          </div>
          <div>
            <h2 className="text-lg font-bold text-foreground/90 mb-2 drop-shadow-sm">Mengapa Memilih Jasa Pembuatan Aplikasi Kami di Jogja?</h2>
            <p className="leading-relaxed">
              Sebagai mitra teknologi terpercaya, layanan <strong>jasa pembuatan aplikasi mobile</strong> kami mencakup UI/UX premium, integrasi CMS, optimasi server, hingga perawatan berkelanjutan. Baik Anda mencari <strong>jasa pembuatan website</strong> perusahaan, <strong>sistem manajemen terpadu</strong>, maupun <strong>aplikasi kasir</strong> untuk mengelola banyak cabang, kami adalah <strong>jasa pembuatan aplikasi Yogyakarta</strong> yang siap menjadi partner Anda.
            </p>
            <p>
              Layanan kami dirancang untuk membantu bisnis Anda berkembang dengan teknologi yang efisien dan modern. Berbasis di Yogyakarta, tim kami menawarkan <strong>jasa developer aplikasi</strong> dengan pengalaman puluhan proyek. Kami siap menghadirkan solusi terbaik yang disesuaikan dengan kebutuhan spesifik bisnis skala kecil (UMKM) hingga enterprise.
            </p>
            <p>
              Kami menawarkan berbagai macam layanan, termasuk <strong>jasa pembuatan aplikasi kasir (POS)</strong>, <strong>sistem ERP</strong>, <strong>aplikasi booking dan antrean</strong>, serta <strong>jasa pembuatan aplikasi Android dan iOS</strong>. Sebagai <strong>software house Jogja</strong>, setiap proyek dikerjakan dengan standar kualitas tertinggi untuk memastikan performa optimal.
            </p>
            <p>
              Sebagai penyedia <strong>jasa pembuatan aplikasi custom</strong> dan <strong>jasa pembuatan website perusahaan</strong> terkemuka, EL Project dikenal luas sebagai pakar terpercaya untuk <strong>layanan jasa pembuatan aplikasi di Yogyakarta (Jogja)</strong>. Kami juga melayani klien di seluruh pelosok Nusantara: Solo, Semarang, Jakarta, Surabaya, Bali, Medan, Makassar, Balikpapan, dan kota lainnya.
            </p>
            <p>Tingkatkan performa bisnis Anda dengan layanan unggulan kami: pembuatan aplikasi <strong>sistem antrean</strong> dan layanan jasa pembuatan aplikasi <strong>absensi terintegrasi</strong>.</p>
          </div>
          <div>
            ...
            <p className="leading-relaxed">
              Meskipun kami berpusat pada <strong>jasa pembuatan aplikasi Yogyakarta</strong>, EL Project melayani klien di <strong>seluruh Indonesia</strong>. Di mana pun bisnis Anda berlokasi, tim ahli kami menangani proyek pembuatan aplikasi secara profesional dengan garansi dukungan teknis berkelanjutan.
            </p>
          </div>
        </div>
      </section>
