...
import { Check, ChevronRight, ClockArrowUp, Code2, Globe, LineChart, Menu, Palette, Search, Server, Shield, Star, X } from "lucide-react";
...
var testimonials = [
	{
		...
		role: "Pengusaha",
		text: /* @__PURE__ */ jsx(Fragment, { children: "Mantaplah pokoknya. Bikin aplikasi kasir eksekusi rapi, garapanya cepat, cocok nih sesuai konsep bisa mengelola banyak cabang..." })
	},
	{
		name: "Sinter Pamong",
...
var AnimatedCounter = ({ end, suffix = "", decimals = 0 }) => {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [count.toFixed(decimals), suffix] });
};
var TypingHighlight = () => {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("p", {
				...
				children: [
					getSub(text1, 0),
					index > end1 && /* @__PURE__ */ jsx("span", {
						className: "text-primary font-semibold",
						children: getSub(text2, end1)
					}),
					index < end2 && /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsxs("p", {
				...
				children: [getSub(text3, end2), index >= end2 && index < end3 && /* @__PURE__ */ jsx("span", {
					className: "animate-pulse",
					children: "|"
				})]
			}),
			/* @__PURE__ */ jsxs("p", {
				className: "text-xs md:text-lg text-muted-foreground min-h-[1.5rem]",
				children: [getSub(text4, end3), index >= end3 && index < 153 && /* @__PURE__ */ jsx("span", {
					className: "animate-pulse",
					children: "|"
				})]
			})
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("a", {
						...
						children: [/* @__PURE__ */ jsxs("a", {
							...
							children: ["Konsultasi ", /* @__PURE__ */ jsx(ChevronRight, { className: "w-4 h-4" })]
						}), /* @__PURE__ */ jsx("button", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("nav", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", { className: "w-full h-px bg-border/50 my-2" }),
								/* @__PURE__ */ jsx("a", {
									href: "https://wa.me/6283867180887?text=halo,saya%20ingin%20menanyakan%20pembuatan%20aplikasi,%0Asepertinya%20saya%20tertarik%20setelah%20melihat%20web%20ini.%0A%0A%0Ahttps://www.elproject.studio",
									target: "_blank",
									rel: "noopener noreferrer",
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("a", {
									...
									children: ["Live Demo ", /* @__PURE__ */ jsx(ChevronRight, { className: "w-4 h-4" })]
								}), /* @__PURE__ */ jsx("a", {
									href: "#layanan",
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("button", {
										...
										children: /* @__PURE__ */ jsx(ChevronRight, { className: "w-4 h-4 rotate-180" })
									}),
									/* @__PURE__ */ jsx("button", {
										onClick: nextSlide,
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsx(TypingHighlight, {})
			}),
			/* @__PURE__ */ jsx("section", {
					...
					children: /* @__PURE__ */ jsx("div", {
						...
						children: [...Array(2)].map((_, i) => /* @__PURE__ */ jsx("div", {
							...
							children: [
								...
								"Python",
								"·"
							].map((t, j) => /* @__PURE__ */ jsx("span", { children: t }, j))
						}, i))
					})
				})
			}),
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: services.map((s, i) => /* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx("div", {
									className: "mb-5",
									children: /* @__PURE__ */ jsx(s.icon, { className: "w-8 h-8 text-primary" })
								}),
								/* @__PURE__ */ jsx("h3", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs(Link, {
								...
								children: ["Lihat Semua", /* @__PURE__ */ jsx(ChevronRight, { className: "w-4 h-4" })]
							})
						]
					}), /* @__PURE__ */ jsx("div", {
						...
						children: features.map((f, i) => /* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx(f.icon, { className: "w-8 h-8 text-primary mb-3" }),
								/* @__PURE__ */ jsx("h3", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("ul", {
									...
									children: p.features.map((f) => /* @__PURE__ */ jsxs("li", {
										...
										children: [/* @__PURE__ */ jsx(Check, { className: "w-4 h-4 text-primary mt-0.5 shrink-0" }), /* @__PURE__ */ jsx("span", {
						...
						children: [
							...
							children: [
								/* @__PURE__ */ jsx("div", {
									...
									children: [...Array(5)].map((_, j) => /* @__PURE__ */ jsx(Star, { className: `w-4 h-4 ${j < (t.rating || 5) ? "fill-primary text-primary" : "text-muted-foreground/30"}` }, `star-${i}-${j}`))
								}),
								/* @__PURE__ */ jsx("p", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("h2", {
							...
							children: ["Siap membangun ", /* @__PURE__ */ jsx("span", {
								className: "text-gradient",
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("a", {
								...
								rel: "noopener noreferrer",
								className: "btn-primary",
								children: ["elproject@studio.id ", /* @__PURE__ */ jsx(ChevronRight, { className: "w-4 h-4" })]
							}), /* @__PURE__ */ jsx("a", {
								href: "https://wa.me/6283867180887?text=halo,saya%20ingin%20menanyakan%20pembuatan%20aplikasi,%0Asepertinya%20saya%20tertarik%20setelah%20melihat%20web%20ini.%0A%0A%0Ahttps://www.elproject.studio",
								target: "_blank",
								rel: "noopener noreferrer",
